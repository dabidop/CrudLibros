...
namespace CRUDDavidAlvarezEF.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(DblibrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar, string filtro)
        {
            ...
            ViewData["FiltroNombres"] = String.IsNullOrEmpty(filtro) ? "NombreDescendente" : "";
            switch (filtro)
            {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DblibrosContext.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
